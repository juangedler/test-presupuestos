...
<div class="panel-heading hbuilt">
	<h3><?php echo __('Editar Grupo'); ?></h3>
</div>
...
<div class="actions col-sm-3">
	...
	<?php echo $this->Form->postLink('<i style="font-size: 20px;" class="pe-7s-trash"></i>', array('action' => 'delete', $this->Form->value('Group.id')),array('escape'=>false), __('¿Está seguro que desea borrar a %s?', $this->Form->value('Group.name'))).'&nbsp;&nbsp;&nbsp;'; ?>
