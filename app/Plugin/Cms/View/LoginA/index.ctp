...
<div class="login-container">
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                ...
                <br>
                <h3>SISTEMA DE GESTION DE USUARIOS</h3>
                <small>¡Bienvenido a sistema de Administración de Usuarios de Ford Colombia!</small>
            </div>
            <div class="hpanel">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <strong>FORD Colombia</strong> - Sistema de Gestión de Usuarios <br/> 2015
        </div>
    </div>
</div>
