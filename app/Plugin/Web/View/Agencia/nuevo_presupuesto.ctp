<div id ="main" class="content ">
	<div class="row">
		...
		<div class="panel-heading hbuilt">
			<h3><?php echo __('Nuevo Presupuesto Publicitario Mindshare ');?></h3>
		</div>
		<div class="panel-body">
			<form method="post" enctype="multipart/form-data">
				<input id="request" style="display:none;" name="request" type="text" class="form-control" value="<?php if(isset($request_id)) echo $request_id;?>"></input>
				<div class="col-sm-12">
