        ...
        <div class="col-md-12">
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <form action="<?php echo $this->Html->url('activar').'/'.$this->Session->read('id');?>" id="loginForm" method="post" enctype="multipart/form-data">
                        ...
                        ?>
                        <div class="form-group">
                            <label class="control-label" for="password">Firma digital</label>
                            <input type="file" title="Por favor seleccione un archivo" required="" value="" name="firma" id="firma" class="form-control" accept=".jpg,.jpeg">
                            <br>
                            <div align="center"><img hidden id="blah" src="#" alt="your image" width="200px" height="200px" /></div>
                        </div>
                        <?php
                            }
                        ?>
