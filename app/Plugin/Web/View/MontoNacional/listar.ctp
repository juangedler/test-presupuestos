		...
		<div class="col-lg-12">
			<div class="hpanel hblue">
				<div class="panel-heading hbuilt">
					<h3>Registros de Monto Nacional</h3>
				</div>
				<div class="panel-body">
					No hay registros de montos nacionales.
				</div>
			</div>
		</div>
	</div>
							...
							<?php
								foreach($nationalMovement as $nm){
									...
									echo '<td align="center">
											<a id="firmar_si" data-href="'.$this->Html->url('/web/administrador/nacional/eliminar/').$nm['NationalMovement']['id'].'" class="pe-7s-trash" title="Eliminar" value="'.$nm['NationalMovement']['id'].'" data-toggle="modal" data-target="#myModal1" style="color:red;font-size: 20px;margin-right:10px;margin-left:10px;"/>
										  </td>';
									echo '</tr>';
								}
							?>
