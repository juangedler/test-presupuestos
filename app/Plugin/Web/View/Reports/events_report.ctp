...
<div class="content">
	<form id="formReportsFilter" action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/web/reports/eventsReportFilter" method="get" enctype="multipart/form-data">
	        	...
	        	<div class="panel-body row">
	        		<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
				        <div class="form-group">
				            <label class="control-label">Fecha inicio (solicitud)</label>
				    ...
				    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
				        <div class="form-group">
				            <label class="control-label">Fecha fin (solicitud)</label>
				            <div class="input-group complete-input">
				                <span class="input-group-addon input-group-addon-special"><i class="glyphicon glyphicon-calendar"></i></span>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
					 ...
					 <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="form-group">
					        <label class="control-label">Producto Ford</label>
					        <div class="input-group complete-input">
								<select class="form-control" id="filterDealership" name="product">
									<option value="0" selected="selected">Seleccione</option>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="form-group">
					        <label class="control-label">Medios</label>
					        <div class="input-group complete-input">
								<select class="form-control" id="filterMedia" name="media">
									<option value="0" selected="selected">Seleccione</option>
