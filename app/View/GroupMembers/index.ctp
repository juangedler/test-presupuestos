<div class="groupMembers index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $groupMember['GroupMember']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $groupMember['GroupMember']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $groupMember['GroupMember']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $groupMember['GroupMember']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
