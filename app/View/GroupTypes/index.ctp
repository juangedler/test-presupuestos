<div class="groupTypes index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $groupType['GroupType']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $groupType['GroupType']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
